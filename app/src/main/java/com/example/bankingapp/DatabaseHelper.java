...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql_tr);
        //to insert data
        insertData("Sonu","roysonu381@gmail.com",5000,"8529735015","XXXXXXXXXXXX4735",db);
        insertData("Baba","baba1999@gmail.com",15000,"802339459","XXXXXXXXXXXX1344",db);
        insertData("Munna","munna123@gmail.com",25000,"2225137174 ","XXXXXXXXXXXX3234",db);
        insertData("Commando","commandoNavin@gmail.com",56000,"2228073554","XXXXXXXXXXXX1284",db);
        insertData("Rajat","rajatarya@gmail.com",54000,"9257472698","XXXXXXXXXXXX1534",db);
        insertData("Monu","monu567@gmail.com",30000,"9834572698","XXXXXXXXXXXX1294",db);
